...
Route::group(array('prefix' => 'back-office'), function() {
    ...
    Route::group(array(
        ...
        Route::resource('link', 'LinkController',array('except' => array('show')));
        Route::get('link/data', array('uses' => 'LinkController@data', 'as' => 'back-office.link.data'));
        ...
        Route::get('nasional/setting', array('uses' => 'SitusController@editNasional', 'as' => 'back-office.nasional.setting.edit'));
        Route::put('nasional/update', array('uses' => 'SitusController@updateNasional', 'as' => 'back-office.nasional.setting.update'));
        ...
        Route::get('chart/{jenis}/create', array('uses' => 'ChartController@create', 'as' => 'back-office.chart.create'));
